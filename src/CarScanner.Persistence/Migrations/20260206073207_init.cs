        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastSignInOnUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DriverLicenseCountry = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PickupInspectionId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClientId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PickupEmployeeId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ReturnEmployeeId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    PickupInspectionId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ReturnInspectionId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PickupPhotoUrl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    ReturnPhotoUrl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    RowVersion = table.Column<byte[]>(type: "rowversion", rowVersion: true, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUserTokens_ApplicationUserId_TokenType",
                table: "ApplicationUserTokens",
                columns: new[] { "ApplicationUserId", "TokenType" });

            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUserTokens_TokenType",
                table: "ApplicationUserTokens",
                column: "TokenType");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DamageReports_TenantId",
                table: "DamageReports",
                column: "TenantId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InspectionPhotos_InspectionId_Position",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VehicleInspections_TenantId",
                table: "VehicleInspections",
                column: "TenantId");
